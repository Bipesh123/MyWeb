             ...
             <table class="table">
                        ...
                        <?php if(count($users)) : ?>
                          ...
                          <tr class="even pointer">
                            ...
                            <td class=" last">
                                <a href="../actions/customer_edit.php?id=<?php echo $user['id']; ?>">Edit</a> |
                                <a onclick="if(confirm('Are you sure to delete this user ?')){return true;}else{return false;}" href="../actions/customer_delete.php?id=<?php echo $user['id']; ?>">Delete</a>
                            </td>
                          </tr>
                            <?php $counter++; ?>
                        <?php endforeach; ?>
