       ...
       <?php foreach($comments as $product): ?>
        ...
        <p>  <b></b> <?php echo $product['comment']; ?></p>
         ...
         <form  enctype="multipart/form-data" method="POST">
                                <!-- <input type ="hidden" value="<?php echo $uid; ?>" name="customer_mail"> -->
                                ...
                                <figure>
                                        <div class="snipcart-thumb">
                                            ...
                                            <h4>Rs. <?php echo print_money($result->price); ?> <?php if($result->price < $result->previous_price): ?>
                                                <span>Rs. <?php echo print_money($result->previous_price); ?> </span>
                                            <?php endif; ?></h4>
                                            <div class="rating">
...
if ($recommed1!=0){
  $recommed1=array_slice($recommed1, 0, 5);
}
display($conn, $recommed1);
echo "</div> </div> </div>";
  ?> 
